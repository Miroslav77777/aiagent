...
def pick_forecast_entry_for_days_ahead(
    ...
    """
    Берём запись прогноза, ближайшую к полудню нужной даты.
    """
...
def pick_tomorrow_forecast_entry(forecast: dict[str, Any]) -> Optional[dict[str, Any]]:
    """
    Берём запись прогноза, ближайшую к завтрашнему полудню.
    """
    return pick_forecast_entry_for_days_ahead(forecast, 1)


def format_tomorrow_weather(location: dict[str, Any], forecast: dict[str, Any]) -> str:
